...
Since: 0.0
'/
TYPE _GooSimplecurve2dClass
  AS GooCanvasPolylineClass parent_class
END TYPE

DECLARE FUNCTION _goo_simplecurve2d_get_type CDECL() AS GType
...
TYPE GooSimplecurve2d AS _GooSimplecurve2d
TYPE GooSimplecurve2dClass AS _GooSimplecurve2dClass
