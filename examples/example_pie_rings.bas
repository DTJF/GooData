' Example: Multi Columns Pie Graph
'
' A <link linkend="GooPie2d">GooPie2d</link> item type "default"
' in case of more than one channel the pie segments are drawn as rings.
'
'~Licence: GPLv3
...
VAR wdth = 340.0, hght = 340.0, line_group = 2.0
...
var pie = goo_pie2d_new(group, Dat, 0.0, 0.0, wdth, hght, _
