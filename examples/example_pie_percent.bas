' Example: Stacked Pie Bars
'
' A <link linkend="GooPie2d">GooPie2d</link> item type "percentage"
' pie segments are stacked like the recangles in a percentage bar chart.
'
'~Licence: GPLv3
...
VAR title = goo_canvas_text_new(group, _
            ...
            "Stacked Pie Bars 100 % scaling" _
            "</span>" _
